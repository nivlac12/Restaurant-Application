...
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile "Sql\Update_Organization.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile "Sql\Update_Restaurant.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile "Sql\Update_Employees.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile "Sql\Update_Jobs.sql"
